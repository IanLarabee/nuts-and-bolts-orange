			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					<div class="navbar-nav">
            			...
            			<?php endif; ?>
						<a class="nav-link active" aria-current="page" href="cart.php"></a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
                    ...
                    <?php endif; ?>
                    <?php
                        if (isset($_GET['cmd']) && $_GET['cmd'] == "removeAllProducts"){
                            unset(($_SESSION["isUser"]) && ($_SESSION["isEmployee"]));
                        }
                        ?>
                        // Code near bottom for completion of this task in PHP
                        <a href="cart.php?cmd=emptycart">Remove All Products from Cart</a>
					</div>
				</div>
			</div>
		</nav>